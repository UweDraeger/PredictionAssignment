...
Goal of the project was to create a model based to predict correct execution or
common mistakes of barbell-lifting exercises based on measurements from fitness
...
newdata has a variable called "problem_id" which is identical to the row number.
Consequently, pml_newdata has no outcome variable and the true out-of-sample
predictive ability of the model remains an open question.
...
The predictions are generated and accuracy and confusion matrix are given.
