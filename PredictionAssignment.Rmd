...
The general expectation would be that the inclusion of more predictors and the
creation of more trees increases in-sample accuracy. However, even with a set of
the smallest parameters (mtry = 2 and trees = 50) the accuracy was above 99%,
equally high were sensitivity and specificity. The increase in acd mean, str_err
